...
public class PendingRecyclerAdapter extends RecyclerView.Adapter<PendingRecyclerAdapter.ViewHolder> {
    ...
    //  1. 資料送進來
    public PendingRecyclerAdapter(Context context, List<Map<String,Object>> productList){
        mainContext = context;
    ...
    @NonNull
    @Override
    public PendingRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = myLayoutInflater.inflate(R.layout.seller_product_items, parent, false);
        PendingRecyclerAdapter.ViewHolder viewHolder = new PendingRecyclerAdapter.ViewHolder(itemView);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull PendingRecyclerAdapter.ViewHolder holder, int position) {
        ...
        holder.textView_sellerProduct_productState.setText("商品審核中");
    }
